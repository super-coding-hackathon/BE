package com.supercoding.hackathon01.advice;
...
public class LoggingAspect {
    ...
    @Before("execution(* com.supercoding.hackathon01..*Controller.*(..))")
    ...
    @AfterReturning(pointcut  = "execution(* com.supercoding.hackathon01..*Controller.*(..))",  returning = "returnValue")
